...
import { Col,Row, Select, Avatar,Typography } from 'antd';
  ...
  return (
    <Col className='coin-detail-container'>
      <Col className='coin-heading-container'>
        <div>
          <Avatar src={cryptoDetails.iconUrl} size={50}/>
      ...
      <Select className="select-timeperiod" defaultValue='24h' placeholder='Select Time Period' onChange={(value) => setTimePeriod(value)}>
        
        {time.map((period) => (
          <Option key={period} value={period} onClick={() => setTimePeriod(period)}>
            {period}
          </Option>
        ))}
      </Select>
      <LineChart  timePeriod={timePeriod} coinHistory={coinHistory} coinName={cryptoDetails.name} currentPrice={cryptoDetails.price} />
